...
*DlocalBalanceApi* | [**getBalance**](docs/Api/DlocalBalanceApi.md#getbalance) | **GET** /dlocal/balance | Get dlocal balances
...
*MandatesApi* | [**getMandate**](docs/Api/MandatesApi.md#getmandate) | **GET** /mandates/{Mandate ID} | Fetch a single mandate
...
## Documentation For Models
 ...
 - [DlocalBalance](docs/Model/DlocalBalance.md)
 - [DlocalBalanceResponse](docs/Model/DlocalBalanceResponse.md)
 ...
 - [MandateStatus](docs/Model/MandateStatus.md)
 ...
 - [PayoutMethodDetailsEGPBank](docs/Model/PayoutMethodDetailsEGPBank.md)
 - [PayoutMethodDetailsEGPCash](docs/Model/PayoutMethodDetailsEGPCash.md)
 ...
 - [PayoutMethodDetailsGHSMobile](docs/Model/PayoutMethodDetailsGHSMobile.md)
