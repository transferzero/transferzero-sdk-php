...
class PayoutMethodTransferReasonEnum
{
    ...
    const DONATIONS_GIFTS = 'donations_gifts';
    const FAMILY_SUPPORT = 'family_support';
    const MORTGAGE_REPAYMENT = 'mortgage_repayment';
    const BUSINESS_TRAVEL = 'business_travel';
    const PERSONAL_TRAVEL = 'personal_travel';
    const MANAGEMENT_CONSULTING = 'management_consulting';
    const ADVERTISING_MARKET_RESEARCH = 'advertising_market_research';
    const CULTURAL_RECREATIONAL = 'cultural_recreational';
    const SALARY_RESIDENT_ABROAD = 'salary_resident_abroad';
    const SALARY_NON_RESIDENT_IN_SA = 'salary_non_resident_in_sa';
    const SALARY_FOREIGN_CONTRACT_IN_SA = 'salary_foreign_contract_in_sa';
    const COMMISSION_BROKERAGE = 'commission_brokerage';
    const INVESTMENT_INCOME = 'investment_income';
    const ARCHITECTURAL_ENGINEERING = 'architectural_engineering';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::OWN_ACCOUNT,
            self::DONATIONS_GIFTS,
            self::FAMILY_SUPPORT,
            self::MORTGAGE_REPAYMENT,
            self::BUSINESS_TRAVEL,
            self::PERSONAL_TRAVEL,
            self::MANAGEMENT_CONSULTING,
            self::ADVERTISING_MARKET_RESEARCH,
            self::CULTURAL_RECREATIONAL,
            self::SALARY_RESIDENT_ABROAD,
            self::SALARY_NON_RESIDENT_IN_SA,
            self::SALARY_FOREIGN_CONTRACT_IN_SA,
            self::COMMISSION_BROKERAGE,
            self::INVESTMENT_INCOME,
            self::ARCHITECTURAL_ENGINEERING,
        ];
    }
}
