...
class AccountValidationApi
{
     ...
     * @return \TransferZero\Model\AccountValidationResponse|\TransferZero\Model\AccountValidationResponse
     */
    public function postAccountValidations($account_validation_request)
    {
        list($response) = $this->postAccountValidationsWithHttpInfo($account_validation_request);
        return $response;
    }
     ...
     */
    public function postAccountValidationsAsync($account_validation_request)
    {
        return $this->postAccountValidationsAsyncWithHttpInfo($account_validation_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function postAccountValidationsRequest($account_validation_request)
    {
        // verify the required parameter 'account_validation_request' is set
        if ($account_validation_request === null || (is_array($account_validation_request) && count($account_validation_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account_validation_request when calling postAccountValidations'
            );
        }

        $resourcePath = '/account_validations';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // body params
        $_tempBody = null;
        if (isset($account_validation_request)) {
            $_tempBody = $account_validation_request;
        }
