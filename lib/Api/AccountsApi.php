...
class AccountsApi
{
    ...
    {
        list($response) = $this->getAccountWithHttpInfo($currency);
        return $response;
    }
     ...
     */
    public function getAccountAsync($currency)
    {
        return $this->getAccountAsyncWithHttpInfo($currency)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function getAccountRequest($currency)
    {
