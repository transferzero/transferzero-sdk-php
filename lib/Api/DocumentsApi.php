...
class DocumentsApi
{
     ...
     */
    public function getDocument($associative_array)
    {
        list($response) = $this->getDocumentWithHttpInfo($associative_array);
        return $response;
    }
     ...
     */
    public function getDocumentWithHttpInfo($associative_array)
    {
        $returnType = '\TransferZero\Model\DocumentResponse';
        $request = $this->getDocumentRequest($associative_array);
     ...
     */
    public function getDocumentAsync($associative_array)
    {
        return $this->getDocumentAsyncWithHttpInfo($associative_array)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDocumentAsyncWithHttpInfo($associative_array)
    {
        $returnType = '\TransferZero\Model\DocumentResponse';
        $request = $this->getDocumentRequest($associative_array);
     ...
     */
    protected function getDocumentRequest($associative_array)
    {
     ...
     */
    public function getDocuments($associative_array)
    {
        list($response) = $this->getDocumentsWithHttpInfo($associative_array);
        return $response;
    }
     ...
     */
    public function getDocumentsWithHttpInfo($associative_array)
    {
        $returnType = '\TransferZero\Model\DocumentListResponse';
        $request = $this->getDocumentsRequest($associative_array);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDocumentsAsync($associative_array)
    {
        return $this->getDocumentsAsyncWithHttpInfo($associative_array)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDocumentsAsyncWithHttpInfo($associative_array)
    {
        $returnType = '\TransferZero\Model\DocumentListResponse';
        $request = $this->getDocumentsRequest($associative_array);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getDocumentsRequest($associative_array)
    {
        // unbox the parameters from the associative array
    ...
    {
        list($response) = $this->postDocumentsWithHttpInfo($document_request);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postDocumentsAsync($document_request)
    {
        return $this->postDocumentsAsyncWithHttpInfo($document_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postDocumentsRequest($document_request)
    {
        ...
        if ($document_request === null || (is_array($document_request) && count($document_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $document_request when calling postDocuments'
            );
        }
