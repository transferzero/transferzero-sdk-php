...
/**
 * OpenCorporatesSupportedCountriesApi Class Doc Comment
 *
 * @category Class
 * @package  TransferZero
 * @author   OpenAPI Generator team
...
class OpenCorporatesSupportedCountriesApi
{
    ...
    /**
     * Operation getOpenCorporatesSupportedCountries
     *
     ...
     * @return \TransferZero\Model\OpenCorporatesSupportedCountriesListResponse
     */
    public function getOpenCorporatesSupportedCountries($associative_array)
    {
        list($response) = $this->getOpenCorporatesSupportedCountriesWithHttpInfo($associative_array);
        return $response;
    }

    /**
     * Operation getOpenCorporatesSupportedCountriesWithHttpInfo
     *
     * Get List of Supported Countries from OpenCorporates
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     ...
     * @throws \TransferZero\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TransferZero\Model\OpenCorporatesSupportedCountriesListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOpenCorporatesSupportedCountriesWithHttpInfo($associative_array)
    {
        $returnType = '\TransferZero\Model\OpenCorporatesSupportedCountriesListResponse';
        $request = $this->getOpenCorporatesSupportedCountriesRequest($associative_array);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        ...
                        '\TransferZero\Model\OpenCorporatesSupportedCountriesListResponse',
    ...
    /**
     * Operation getOpenCorporatesSupportedCountriesAsync
     *
     * Get List of Supported Countries from OpenCorporates
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     ...
     */
    public function getOpenCorporatesSupportedCountriesAsync($associative_array)
    {
        return $this->getOpenCorporatesSupportedCountriesAsyncWithHttpInfo($associative_array)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getOpenCorporatesSupportedCountriesAsyncWithHttpInfo
     *
     * Get List of Supported Countries from OpenCorporates
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOpenCorporatesSupportedCountriesAsyncWithHttpInfo($associative_array)
    {
        $returnType = '\TransferZero\Model\OpenCorporatesSupportedCountriesListResponse';
        $request = $this->getOpenCorporatesSupportedCountriesRequest($associative_array);
    ...
    /**
     * Create request for operation 'getOpenCorporatesSupportedCountries'
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     *
     *
     ...
     */
    protected function getOpenCorporatesSupportedCountriesRequest($associative_array)
    {
        // unbox the parameters from the associative array


        $resourcePath = '/open_corporates/countries';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
