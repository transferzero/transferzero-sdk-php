...
class APILogsApi
{
    ...
    {
        list($response) = $this->getApiLogWithHttpInfo($api_log_id);
        return $response;
    }
     ...
     */
    public function getApiLogAsync($api_log_id)
    {
        return $this->getApiLogAsyncWithHttpInfo($api_log_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function getApiLogRequest($api_log_id)
    {
    ...
    {
        list($response) = $this->getApiLogsWithHttpInfo($page, $per, $created_at_from, $created_at_to);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getApiLogsAsync($page = null, $per = null, $created_at_from = null, $created_at_to = null)
    {
        return $this->getApiLogsAsyncWithHttpInfo($page, $per, $created_at_from, $created_at_to)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getApiLogsRequest($page = null, $per = null, $created_at_from = null, $created_at_to = null)
    {
