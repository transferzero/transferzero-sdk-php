...
class AccountDebitsApi
{
    ...
    {
        list($response) = $this->getAccountsDebitWithHttpInfo($account_debit_id);
        return $response;
    }
     ...
     */
    public function getAccountsDebitAsync($account_debit_id)
    {
        return $this->getAccountsDebitAsyncWithHttpInfo($account_debit_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function getAccountsDebitRequest($account_debit_id)
    {
    ...
    {
        list($response) = $this->getAccountsDebitsWithHttpInfo($page, $per);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAccountsDebitsAsync($page = null, $per = null)
    {
        return $this->getAccountsDebitsAsyncWithHttpInfo($page, $per)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAccountsDebitsRequest($page = null, $per = null)
    {
