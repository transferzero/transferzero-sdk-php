...
/**
 * SanctionedCountriesApi Class Doc Comment
 *
 * @category Class
 * @package  TransferZero
 * @author   OpenAPI Generator team
...
class SanctionedCountriesApi
{
    ...
    /**
     * Operation getSanctionedCountries
     *
     ...
     * @return \TransferZero\Model\SanctionedCountryListResponse
     */
    public function getSanctionedCountries($associative_array)
    {
        list($response) = $this->getSanctionedCountriesWithHttpInfo($associative_array);
        return $response;
    }

    /**
     * Operation getSanctionedCountriesWithHttpInfo
     *
     * Get List of Sanctioned Countries
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     ...
     * @throws \TransferZero\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TransferZero\Model\SanctionedCountryListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSanctionedCountriesWithHttpInfo($associative_array)
    {
        $returnType = '\TransferZero\Model\SanctionedCountryListResponse';
        $request = $this->getSanctionedCountriesRequest($associative_array);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        ...
                        '\TransferZero\Model\SanctionedCountryListResponse',
    ...
    /**
     * Operation getSanctionedCountriesAsync
     *
     * Get List of Sanctioned Countries
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     ...
     */
    public function getSanctionedCountriesAsync($associative_array)
    {
        return $this->getSanctionedCountriesAsyncWithHttpInfo($associative_array)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSanctionedCountriesAsyncWithHttpInfo
     *
     * Get List of Sanctioned Countries
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSanctionedCountriesAsyncWithHttpInfo($associative_array)
    {
        $returnType = '\TransferZero\Model\SanctionedCountryListResponse';
        $request = $this->getSanctionedCountriesRequest($associative_array);
    ...
    /**
     * Create request for operation 'getSanctionedCountries'
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     *
     *
     ...
     */
    protected function getSanctionedCountriesRequest($associative_array)
    {
        // unbox the parameters from the associative array


        $resourcePath = '/sanctioned_countries';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
