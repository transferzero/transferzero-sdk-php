...
class LogsApi
{
    ...
    {
        list($response) = $this->getWebhookLogWithHttpInfo($webhook_log_id);
        return $response;
    }
     ...
     */
    public function getWebhookLogAsync($webhook_log_id)
    {
        return $this->getWebhookLogAsyncWithHttpInfo($webhook_log_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function getWebhookLogRequest($webhook_log_id)
    {
    ...
    {
        list($response) = $this->getWebhookLogsWithHttpInfo($page, $per, $created_at_from, $created_at_to);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWebhookLogsAsync($page = null, $per = null, $created_at_from = null, $created_at_to = null)
    {
        return $this->getWebhookLogsAsyncWithHttpInfo($page, $per, $created_at_from, $created_at_to)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getWebhookLogsRequest($page = null, $per = null, $created_at_from = null, $created_at_to = null)
    {
