...
class PaymentMethodsApi
{
     ...
     */
    public function paymentMethodsIn($associative_array)
    {
        list($response) = $this->paymentMethodsInWithHttpInfo($associative_array);
        return $response;
    }
     ...
     */
    public function paymentMethodsInWithHttpInfo($associative_array)
    {
        $returnType = '\TransferZero\Model\PaymentMethodListResponse';
        $request = $this->paymentMethodsInRequest($associative_array);
     ...
     */
    public function paymentMethodsInAsync($associative_array)
    {
        return $this->paymentMethodsInAsyncWithHttpInfo($associative_array)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function paymentMethodsInAsyncWithHttpInfo($associative_array)
    {
        $returnType = '\TransferZero\Model\PaymentMethodListResponse';
        $request = $this->paymentMethodsInRequest($associative_array);
     ...
     */
    protected function paymentMethodsInRequest($associative_array)
    {
     ...
     * @return \TransferZero\Model\PaymentMethodListResponse
     */
    public function paymentMethodsOut($associative_array)
    {
        list($response) = $this->paymentMethodsOutWithHttpInfo($associative_array);
        return $response;
    }
     ...
     * @return array of \TransferZero\Model\PaymentMethodListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function paymentMethodsOutWithHttpInfo($associative_array)
    {
        $returnType = '\TransferZero\Model\PaymentMethodListResponse';
        $request = $this->paymentMethodsOutRequest($associative_array);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function paymentMethodsOutAsync($associative_array)
    {
        return $this->paymentMethodsOutAsyncWithHttpInfo($associative_array)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function paymentMethodsOutAsyncWithHttpInfo($associative_array)
    {
        $returnType = '\TransferZero\Model\PaymentMethodListResponse';
        $request = $this->paymentMethodsOutRequest($associative_array);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function paymentMethodsOutRequest($associative_array)
    {
        // unbox the parameters from the associative array
