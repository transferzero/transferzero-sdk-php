...
class PayoutMethodsApi
{
    ...
    {
        list($response) = $this->getPayoutMethodWithHttpInfo($payout_method_id);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPayoutMethodAsync($payout_method_id)
    {
        return $this->getPayoutMethodAsyncWithHttpInfo($payout_method_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPayoutMethodRequest($payout_method_id)
    {
        // verify the required parameter 'payout_method_id' is set
        if ($payout_method_id === null || (is_array($payout_method_id) && count($payout_method_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    {
        list($response) = $this->getPayoutMethodsWithHttpInfo($state, $type, $sender_id, $page, $per, $created_at_from, $created_at_to);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPayoutMethodsAsync($state = null, $type = null, $sender_id = null, $page = null, $per = null, $created_at_from = null, $created_at_to = null)
    {
        return $this->getPayoutMethodsAsyncWithHttpInfo($state, $type, $sender_id, $page, $per, $created_at_from, $created_at_to)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPayoutMethodsRequest($state = null, $type = null, $sender_id = null, $page = null, $per = null, $created_at_from = null, $created_at_to = null)
    {
