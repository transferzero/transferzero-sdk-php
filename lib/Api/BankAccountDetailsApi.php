...
/**
 * BankAccountDetailsApi Class Doc Comment
 *
 * @category Class
 * @package  TransferZero
 * @author   OpenAPI Generator team
...
class BankAccountDetailsApi
{
    ...
    /**
     * Operation getBankAccountDetails
     *
     * Fetching bank account details
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     *
     * @param  string $currency Currency of the required bank account details.  Example: &#x60;/v1/bank_account_details/NGN&#x60; (required)
     *
     * @throws \TransferZero\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TransferZero\Model\BankAccountDetailsResponse
     */
    public function getBankAccountDetails($associative_array)
    {
        list($response) = $this->getBankAccountDetailsWithHttpInfo($associative_array);
        return $response;
    }

    /**
     * Operation getBankAccountDetailsWithHttpInfo
     *
     * Fetching bank account details
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     ...
     * @throws \TransferZero\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TransferZero\Model\BankAccountDetailsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBankAccountDetailsWithHttpInfo($associative_array)
    {
        $returnType = '\TransferZero\Model\BankAccountDetailsResponse';
        $request = $this->getBankAccountDetailsRequest($associative_array);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        ...
                        '\TransferZero\Model\BankAccountDetailsResponse',
    ...
    /**
     * Operation getBankAccountDetailsAsync
     *
     * Fetching bank account details
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     ...
     */
    public function getBankAccountDetailsAsync($associative_array)
    {
        return $this->getBankAccountDetailsAsyncWithHttpInfo($associative_array)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getBankAccountDetailsAsyncWithHttpInfo
     *
     * Fetching bank account details
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBankAccountDetailsAsyncWithHttpInfo($associative_array)
    {
        $returnType = '\TransferZero\Model\BankAccountDetailsResponse';
        $request = $this->getBankAccountDetailsRequest($associative_array);
    ...
    /**
     * Create request for operation 'getBankAccountDetails'
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     *
     * @param  string $currency Currency of the required bank account details.  Example: &#x60;/v1/bank_account_details/NGN&#x60; (required)
     ...
     */
    protected function getBankAccountDetailsRequest($associative_array)
    {
        ...
        if ($currency === null || (is_array($currency) && count($currency) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $currency when calling getBankAccountDetails'
            );
        }

        $resourcePath = '/bank_account_details/{Currency}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
