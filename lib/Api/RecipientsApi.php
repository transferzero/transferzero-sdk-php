...
class RecipientsApi
{
    ...
    {
        list($response) = $this->getRecipientsWithHttpInfo($page, $per, $created_at_from, $created_at_to, $amount_from, $amount_to, $state, $currency);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRecipientsAsync($page = null, $per = null, $created_at_from = null, $created_at_to = null, $amount_from = null, $amount_to = null, $state = null, $currency = null)
    {
        return $this->getRecipientsAsyncWithHttpInfo($page, $per, $created_at_from, $created_at_to, $amount_from, $amount_to, $state, $currency)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getRecipientsRequest($page = null, $per = null, $created_at_from = null, $created_at_to = null, $amount_from = null, $amount_to = null, $state = null, $currency = null)
    {
