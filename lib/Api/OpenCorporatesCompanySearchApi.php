...
/**
 * OpenCorporatesCompanySearchApi Class Doc Comment
 *
 * @category Class
 * @package  TransferZero
 * @author   OpenAPI Generator team
...
class OpenCorporatesCompanySearchApi
{
     ...
     *
     * @param  \TransferZero\Model\OpenCorporatesSearchRequest $open_corporates_search_request open_corporates_search_request (required)
     *
     * @throws \TransferZero\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TransferZero\Model\OpenCorporatesSearchResponse|\TransferZero\Model\OpenCorporatesSearchResponse
     */
    public function searchCompany($open_corporates_search_request)
    {
        list($response) = $this->searchCompanyWithHttpInfo($open_corporates_search_request);
        return $response;
    }
     ...
     * Search for a company on Open Corporates
     *
     * @param  \TransferZero\Model\OpenCorporatesSearchRequest $open_corporates_search_request (required)
     *
     * @throws \TransferZero\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TransferZero\Model\OpenCorporatesSearchResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchCompanyWithHttpInfo($open_corporates_search_request)
    {
        $returnType = '\TransferZero\Model\OpenCorporatesSearchResponse';
        $request = $this->searchCompanyRequest($open_corporates_search_request);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        ...
                        '\TransferZero\Model\OpenCorporatesSearchResponse',
     ...
     */
    public function searchCompanyAsync($open_corporates_search_request)
    {
        return $this->searchCompanyAsyncWithHttpInfo($open_corporates_search_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchCompanyAsyncWithHttpInfo($open_corporates_search_request)
    {
        $returnType = '\TransferZero\Model\OpenCorporatesSearchResponse';
        $request = $this->searchCompanyRequest($open_corporates_search_request);
     ...
     */
    protected function searchCompanyRequest($open_corporates_search_request)
    {
        // verify the required parameter 'open_corporates_search_request' is set
        if ($open_corporates_search_request === null || (is_array($open_corporates_search_request) && count($open_corporates_search_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $open_corporates_search_request when calling searchCompany'
            );
        }

        $resourcePath = '/open_corporates/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // body params
        $_tempBody = null;
        if (isset($open_corporates_search_request)) {
            $_tempBody = $open_corporates_search_request;
        }
