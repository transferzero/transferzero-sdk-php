...
class SendersApi
{
    ...
    /**
     * Operation confirmSenderVerification
     *
     * Change sender onboarding state to 'profile_completed'
     *
     * @param  string $sender_id ID of the sender to get.  Example: &#x60;/v1/senders/bf9ff782-e182-45ac-abea-5bce83ad6670/confirm_verification&#x60; (required)
     *
     * @throws \TransferZero\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TransferZero\Model\SenderResponse|\TransferZero\Model\SenderResponse
     */
    public function confirmSenderVerification($sender_id)
    {
        list($response) = $this->confirmSenderVerificationWithHttpInfo($sender_id);
        return $response;
    }

    /**
     * Operation confirmSenderVerificationWithHttpInfo
     *
     * Change sender onboarding state to 'profile_completed'
     *
     * @param  string $sender_id ID of the sender to get.  Example: &#x60;/v1/senders/bf9ff782-e182-45ac-abea-5bce83ad6670/confirm_verification&#x60; (required)
     ...
     */
    public function confirmSenderVerificationWithHttpInfo($sender_id)
    {
        $returnType = '\TransferZero\Model\SenderResponse';
        $request = $this->confirmSenderVerificationRequest($sender_id);
    ...
    /**
     * Operation confirmSenderVerificationAsync
     *
     * Change sender onboarding state to 'profile_completed'
     *
     * @param  string $sender_id ID of the sender to get.  Example: &#x60;/v1/senders/bf9ff782-e182-45ac-abea-5bce83ad6670/confirm_verification&#x60; (required)
     ...
     */
    public function confirmSenderVerificationAsync($sender_id)
    {
        return $this->confirmSenderVerificationAsyncWithHttpInfo($sender_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation confirmSenderVerificationAsyncWithHttpInfo
     *
     * Change sender onboarding state to 'profile_completed'
     *
     * @param  string $sender_id ID of the sender to get.  Example: &#x60;/v1/senders/bf9ff782-e182-45ac-abea-5bce83ad6670/confirm_verification&#x60; (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function confirmSenderVerificationAsyncWithHttpInfo($sender_id)
    {
        $returnType = '\TransferZero\Model\SenderResponse';
        $request = $this->confirmSenderVerificationRequest($sender_id);
    ...
    /**
     * Create request for operation 'confirmSenderVerification'
     *
     * @param  string $sender_id ID of the sender to get.  Example: &#x60;/v1/senders/bf9ff782-e182-45ac-abea-5bce83ad6670/confirm_verification&#x60; (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function confirmSenderVerificationRequest($sender_id)
    {
        // verify the required parameter 'sender_id' is set
        if ($sender_id === null || (is_array($sender_id) && count($sender_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $sender_id when calling confirmSenderVerification'
            );
        }

        $resourcePath = '/senders/{Sender ID}/confirm_verification';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function getSender($associative_array)
    {
        list($response) = $this->getSenderWithHttpInfo($associative_array);
        return $response;
    }
     ...
     * @return array of \TransferZero\Model\SenderResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSenderWithHttpInfo($associative_array)
    {
        $returnType = '\TransferZero\Model\SenderResponse';
        $request = $this->getSenderRequest($associative_array);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSenderAsync($associative_array)
    {
        return $this->getSenderAsyncWithHttpInfo($associative_array)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSenderAsyncWithHttpInfo($associative_array)
    {
        $returnType = '\TransferZero\Model\SenderResponse';
        $request = $this->getSenderRequest($associative_array);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSenderRequest($associative_array)
    {
     ...
     */
    public function getSenders($associative_array)
    {
        list($response) = $this->getSendersWithHttpInfo($associative_array);
        return $response;
    }
     ...
     */
    public function getSendersWithHttpInfo($associative_array)
    {
        $returnType = '\TransferZero\Model\SenderListResponse';
        $request = $this->getSendersRequest($associative_array);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSendersAsync($associative_array)
    {
        return $this->getSendersAsyncWithHttpInfo($associative_array)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSendersAsyncWithHttpInfo($associative_array)
    {
        $returnType = '\TransferZero\Model\SenderListResponse';
        $request = $this->getSendersRequest($associative_array);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSendersRequest($associative_array)
    {
        // unbox the parameters from the associative array
