...
class TransactionsApi
{
     ...
     * @return \TransferZero\Model\TransactionResponse|\TransferZero\Model\TransactionResponse
     */
     ...
     * @throws \TransferZero\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TransferZero\Model\TransactionResponse|\TransferZero\Model\ErrorStatus|\TransferZero\Model\TransactionResponse
     */
     ...
     * @throws \TransferZero\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TransferZero\Model\TransactionResponse|\TransferZero\Model\ErrorStatus
     */
    public function getTransaction($associative_array)
    {
        list($response) = $this->getTransactionWithHttpInfo($associative_array);
        return $response;
    }
     ...
     * @return array of \TransferZero\Model\TransactionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTransactionWithHttpInfo($associative_array)
    {
        $returnType = '\TransferZero\Model\TransactionResponse';
        $request = $this->getTransactionRequest($associative_array);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTransactionAsync($associative_array)
    {
        return $this->getTransactionAsyncWithHttpInfo($associative_array)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTransactionAsyncWithHttpInfo($associative_array)
    {
        $returnType = '\TransferZero\Model\TransactionResponse';
        $request = $this->getTransactionRequest($associative_array);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getTransactionRequest($associative_array)
    {
     ...
     * @throws \TransferZero\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TransferZero\Model\TransactionListResponse|\TransferZero\Model\ErrorStatus
     */
    public function getTransactions($associative_array)
    {
        list($response) = $this->getTransactionsWithHttpInfo($associative_array);
        return $response;
    }
     ...
     */
    public function getTransactionsWithHttpInfo($associative_array)
    {
        $returnType = '\TransferZero\Model\TransactionListResponse';
        $request = $this->getTransactionsRequest($associative_array);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTransactionsAsync($associative_array)
    {
        return $this->getTransactionsAsyncWithHttpInfo($associative_array)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTransactionsAsyncWithHttpInfo($associative_array)
    {
        $returnType = '\TransferZero\Model\TransactionListResponse';
        $request = $this->getTransactionsRequest($associative_array);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getTransactionsRequest($associative_array)
    {
        // unbox the parameters from the associative array
