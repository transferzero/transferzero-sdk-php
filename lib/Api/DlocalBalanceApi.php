...
/**
 * DlocalBalanceApi Class Doc Comment
 *
 * @category Class
 * @package  TransferZero
 * @author   OpenAPI Generator team
...
class DlocalBalanceApi
{
     ...
     * @return \TransferZero\Model\DlocalBalanceResponse
     */
     ...
     * @throws \TransferZero\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TransferZero\Model\DlocalBalanceResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBalanceWithHttpInfo()
    {
        $returnType = '\TransferZero\Model\DlocalBalanceResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        ...
                        '\TransferZero\Model\DlocalBalanceResponse',
