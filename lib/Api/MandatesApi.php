...
class MandatesApi
{
     ...
     *
     * @param  string $mandate_id ID of the mandate.  Example: &#x60;/v1/mandates/bf9ff782-e182-45ac-abea-5bce83ad6670&#x60; (required)
     *
     * @throws \TransferZero\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TransferZero\Model\MandateResponse
     */
    public function getMandate($associative_array)
    {
        list($response) = $this->getMandateWithHttpInfo($associative_array);
        return $response;
    }
     ...
     * @throws \TransferZero\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TransferZero\Model\MandateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMandateWithHttpInfo($associative_array)
    {
        $returnType = '\TransferZero\Model\MandateResponse';
        $request = $this->getMandateRequest($associative_array);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        ...
                        '\TransferZero\Model\MandateResponse',
     ...
     */
    public function getMandateAsync($associative_array)
    {
        return $this->getMandateAsyncWithHttpInfo($associative_array)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMandateAsyncWithHttpInfo($associative_array)
    {
        $returnType = '\TransferZero\Model\MandateResponse';
        $request = $this->getMandateRequest($associative_array);
     ...
     */
    protected function getMandateRequest($associative_array)
    {
        // unbox the parameters from the associative array
        $mandate_id = array_key_exists('mandate_id', $associative_array) ? $associative_array['mandate_id'] : null;
        ...
        $resourcePath = '/mandates/{Mandate ID}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
